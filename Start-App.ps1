...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd backend; `$env:LOCAL_MODE='ON'; Write-Host 'Starting Backend (LOCAL_MODE=ON)...'; uvicorn main:app --reload --reload-include .env --host 0.0.0.0 --port 8000"
